            ...
            <div className="tile is-parent">
              <div className="tile is-child element">
                <Link to="/topixmedialab">
                  ...
                  <div className="overlay">
                    <div className="element-type">
                      <h6 className="h6">EDITORIAL</h6>
                      <h3 className="h3">Topix Media Lab</h3>
                    </div>
                  </div>
                </Link>
              </div>
              ...
              <div className="tile is-child element">
                <Link to="/edipresse">
                  ...
                  <div className="overlay">
                    <div className="element-type">
                      <h6 className="h6">EDITORIAL</h6>
                      <h3 className="h3">Hong Kong Tatler Weddings</h3>
                    </div>
                  </div>
                </Link>
              </div>
